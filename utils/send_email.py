...
def send_yagmail(emails_to, subject, message, email_from = None, attachment_path =  None, smtp_server = None, smtp_server_port = None):
    ...
    if not smtp_server:
        ...
        smtp_server = os.environ.get('ST_SMTP_SERVER')
...
if __name__ == '__main__':
    ...
    send_yagmail ('stasrirak.ms@gmail.com, stasrira@yahoo.com, stas.rirak@mssm.edu', 'Test Email #5.4', '<font color ="blue">Body</font> of the <b>test</b> email!!.', None, 'test.png')
